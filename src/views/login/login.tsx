    ...
    login(values)
      .then((data) => {
        if (data.flag === "SUCCESS" || data.token) {
          ...
          if (location.state.referPage)
            navigate(location.state.referPage, { replace: true });
        }
      })
      .catch((e) => {
        console.log(e);
  ...
  return (
    <div>
      <div className="login">
        ...
        <img src={company} className="company" alt="" />
        <div className="main">
          <Form
            onFinish={onSubmit}
            required={true}
            ...
            footer={
              <div
                className={`comNormalSubBtn ${
                  checked ? "" : "comNormalSubBtnDisabled"
                }`}
              >
                <Button
                  round
          ...
          >
            ...
            <div className="checkWrap">
              ...
              <span className="xy">
                <span onClick={showYhxy}>《用户协议》</span>、
                <span onClick={showYsxy}>《隐私政策》</span>
              </span>
